          ...
          <CardContent className="p-6">
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <p className="text-xs font-bold uppercase tracking-wider text-gray-600 mt-1">Total Categories</p>
              </div>
            </div>
          </CardContent>
        </Card>
          ...
          <CardContent className="p-6">
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <p className="text-xs font-bold uppercase tracking-wider text-gray-600 mt-1">Active Categories</p>
              </div>
            </div>
          </CardContent>
        </Card>
      ...
      <Card className="rounded-[12px] border-gray-200 bg-white shadow-sm">
        <CardHeader className="pb-4 border-b border-gray-200 bg-muted/5">
          <div className="flex flex-col sm:flex-row gap-4 justify-between items-start sm:items-center">
            <div>
              <CardTitle className="font-sans font-bold text-black font-bold uppercase tracking-wide text-lg">Categories</CardTitle>
              ...
              <TableBody>
                {filteredCategories.length === 0 ? (
                  ...
                  filteredCategories.map((category) => (
                    <TableRow key={category._id} className="border-gray-200 hover:bg-muted/10 transition-colors">
