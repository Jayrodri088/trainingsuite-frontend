  ...
  return (
    <div className="space-y-8 animate-in fade-in duration-500">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        <div>
          <h1 className="text-3xl font-sans font-bold text-black font-bold uppercase tracking-tight">Live Sessions</h1>
          ...
          <CardContent className="p-6">
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <p className="text-xs font-bold uppercase tracking-wider text-gray-600 mt-1">Total Sessions</p>
              </div>
            </div>
          </CardContent>
        </Card>
          ...
          <CardContent className="p-6">
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <p className="text-xs font-bold uppercase tracking-wider text-gray-600 mt-1">Live Now</p>
              </div>
            </div>
          </CardContent>
        </Card>
          ...
          <CardContent className="p-6">
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <p className="text-xs font-bold uppercase tracking-wider text-gray-600 mt-1">Completed</p>
              </div>
            </div>
          </CardContent>
        </Card>
      ...
      <Card className="rounded-[12px] border-gray-200 bg-white shadow-sm">
        <CardHeader className="pb-4 border-b border-gray-200 bg-muted/5">
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
            <div>
              <CardTitle className="font-sans font-bold text-black font-bold uppercase tracking-wide text-lg">All Sessions</CardTitle>
              <CardDescription>
              ...
              <Table>
                ...
                <TableBody>
                  {filteredSessions.map((session) => (
                    <TableRow key={session._id} className="border-gray-200 hover:bg-muted/10 transition-colors">
                      ...
                      <TableCell>
                        ...
                        <div className="flex items-center gap-2 text-xs font-mono text-gray-600 mt-0.5">
                          <Clock className="h-3.5 w-3.5" />
                          {format(parseISO(session.scheduledAt), "h:mm a")}
                        </div>
                      </TableCell>
                      <TableCell className="text-xs font-mono">
                        {session.duration ? `${session.duration} min` : <span className="text-gray-600">—</span>}
                      </TableCell>
                      <TableCell>
        ...
        <DialogContent className="w-[95vw] max-w-lg rounded-[12px] border-gray-200 bg-white shadow-sm max-h-[90vh] overflow-y-auto">
          ...
          <form onSubmit={handleSubmit}>
            <div className="space-y-4 py-4">
              ...
              <div className="space-y-2">
                <Label htmlFor="description" className="text-xs font-bold uppercase tracking-wider text-gray-600">Description</Label>
                <Textarea
                  id="description"
              ...
              {/* Thumbnail Upload */}
              <div className="space-y-2">
                <Label className="text-xs font-bold uppercase tracking-wider text-gray-600">Thumbnail</Label>
                <div className="space-y-3">
                  {thumbnailPreview ? (
                    ...
                    <label
                      ...
                      className="flex flex-col items-center justify-center aspect-video border-2 border-dashed border-gray-200 cursor-pointer hover:bg-muted/50 transition-colors"
                    >
              ...
              <div className="space-y-2">
                <Label htmlFor="course" className="text-xs font-bold uppercase tracking-wider text-gray-600">Related Course (Optional)</Label>
                <Select
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div className="space-y-2">
                  <Label htmlFor="scheduledAt" className="text-xs font-bold uppercase tracking-wider text-gray-600">Date & Time *</Label>
                  <Input
                    id="scheduledAt"
                    type="datetime-local"
                ...
                <div className="space-y-2">
                  <Label htmlFor="streamProvider" className="text-xs font-bold uppercase tracking-wider text-gray-600">Stream Provider</Label>
                  <Select
              ...
              <div className="space-y-3 p-3 sm:p-4 border border-gray-200 rounded-[10px] bg-muted/20">
                ...
                {formData.hasDurationLimit && (
                  <div className="space-y-2 pt-2">
                    <Label htmlFor="duration" className="text-xs font-bold uppercase tracking-wider text-gray-600">Duration (minutes)</Label>
                    <Input
                      id="duration"
                      type="number"
                      min="15"
              ...
              <div className="space-y-3 p-3 sm:p-4 border border-gray-200 rounded-[10px] bg-muted/20">
                ...
                {formData.hasMaxAttendees && (
                  <div className="space-y-2 pt-2">
                    <Label htmlFor="maxAttendees" className="text-xs font-bold uppercase tracking-wider text-gray-600">Max Attendees</Label>
                    <Input
                      id="maxAttendees"
                      type="number"
                      min="1"
              ...
              <div className="space-y-2">
                <Label htmlFor="streamUrl" className="text-xs font-bold uppercase tracking-wider text-gray-600">Stream URL</Label>
                <Input
                  id="streamUrl"
