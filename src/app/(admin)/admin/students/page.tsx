          ...
          <CardContent className="p-6">
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <p className="text-xs font-bold uppercase tracking-wider text-gray-600 mt-1">Total Students</p>
              </div>
            </div>
          </CardContent>
        </Card>
          ...
          <CardContent className="p-6">
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <p className="text-xs font-bold uppercase tracking-wider text-gray-600 mt-1">Active Enrollments</p>
              </div>
            </div>
          </CardContent>
        </Card>
          ...
          <CardContent className="p-6">
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <p className="text-xs font-bold uppercase tracking-wider text-gray-600 mt-1">Avg Progress</p>
              </div>
            </div>
          </CardContent>
        </Card>
