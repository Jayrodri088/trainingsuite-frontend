    ...
    <section className="relative py-16 md:py-24 lg:py-32 overflow-hidden">
      ...
      <div className="container max-w-7xl px-4 md:px-8 relative z-10">
        ...
        <div className="flex flex-col lg:flex-row lg:items-stretch gap-10 lg:gap-12">
          {/* Left – image block (same height as right content). Two separate containers: empty frame + course image. */}
          <div className="order-2 lg:order-1 lg:min-w-0 lg:flex-1 lg:max-w-[50%] flex min-h-[280px] lg:min-h-0 lg:h-full">
          ...
          {/* Right – content + CTA (this block’s height drives the row) */}
          <div className="order-1 lg:order-2 lg:flex-1 lg:min-w-0 flex flex-col justify-center space-y-6">
            ...
            <div className="pt-2">
              {isAuthenticated ? (
                <Button
                  size="lg"
                  className="h-12 px-8 rounded-lg bg-white text-black hover:bg-white/90 font-medium text-sm"
                  asChild
                >
                ...
                <Button
                  size="lg"
                  className="h-12 px-8 rounded-[12px] bg-white text-black hover:bg-white/90 font-medium text-sm"
                  asChild
                >
